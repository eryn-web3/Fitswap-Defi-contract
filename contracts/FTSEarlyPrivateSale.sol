...
contract FTSEarlyPrivateSale {
    ...
    uint256 public totalTokensToSell = 15000000 * 10**18;          // 15000000 FTS tokens for sell
    uint256 public ftsPerBnb = 15000 * 10**18;             // 1 BNB = 15000 FTS
